    ...
    render(): JSX.Element {
        ...
        return address ? (
            <div className="container-fluid">
                <div className="row">
                    <nav className="col-0 col-sm-2 col-xl-1 px-0 d-none d-md-flex flex-column sidebar bg-secondary justify-content-between">
                    ...
                    <div className="col-12 col-sm-10 col-xl-11">{children}</div>
                </div>
            </div>
        ) : (
